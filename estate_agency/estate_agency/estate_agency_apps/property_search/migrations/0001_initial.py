    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_category', models.ManyToManyField(related_name='search_property_category', to='property.propertycategory')),
                ('property_type', models.ManyToManyField(related_name='search_property_type', to='property.propertytype')),
                ('repair_state', models.ManyToManyField(related_name='search_repair_state', to='property.repairstate')),
