...
SECRET_KEY = 'django-insecure-e#cu4k0!^jupd!1#&gp12gf+yg@+mq1p-a^z%5@v%q7j+k5wb%'
...
ALLOWED_HOSTS = []
LOCAL_APPS = [
    'estate_agency.estate_agency_apps.common.apps.CommonConfig',
...
ROOT_URLCONF = 'estate_agency.config.urls'
...
WSGI_APPLICATION = 'estate_agency.config.wsgi.application'
